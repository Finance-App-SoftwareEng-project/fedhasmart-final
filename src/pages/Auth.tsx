        ...
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-primary via-primary to-primary/80 p-4 rounded-2xl shadow-xl">
                <CircleDollarSign className="h-12 w-12 text-primary-foreground" />
              </div>
            </div>
          </div>
