      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <NotificationBell />
            <ThemeToggle />
            <Button variant="ghost" asChild size="icon" title="Profile" className="hidden md:inline-flex">
              <Link to="/profile">
                <User className="h-4 w-4" />
              </Link>
            </Button>
            <Button variant="ghost" asChild size="icon" title="Settings" className="hidden md:inline-flex">
              <Link to="/settings">
